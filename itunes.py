...
def np_cb(word, word_eol, userdata):
	...
	try:
		...
		if track.Album == track.Artist:
                        hexchat.command('me now playing {} from {}\'s self titled album'.format(track.Name, track.Artist))
		else:
                        hexchat.command('me now playing {} from {}\'s {}'.format(track.Name, track.Artist, track.Album))
